...
pub const MATCH_RESULT_TYPE_REAL: u8 = 1; // Order price type: Limit
pub const MATCH_RESULT_TYPE_MOCK: u8 = 2; // Order price type: Market
...
pub struct MatchResult {
    ...
    pub result_type: u8,          // Result Type 1 byte
}

// #[derive(Debug, Clone)]
// pub enum MatchResult {
//     /// A result generated by the live order book, requires actual trade execution.
//     Real(RealMatchResult),
//     /// A result generated during simulation or testing, requires logging/analysis only.
//     Mock(MockMatchResult),
// }
